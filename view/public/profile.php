            ...
            <div class="description lg:ml-5 h-[100%] flex flex-col">
                ...
                <div class="formation_status flex justify-center lg:justify-normal items-center px-3 mt-2">
                    ...
                    <form id="user-status-update" class="hidden space-x-4">
                        <select name="user_status" class="border-main-red px-4 py-2">
                            ...
                            <option value="<?= $eachStatus['status_id'] ?>" <?php if ($eachStatus['status_id'] == $userDatas->user_status_id) {
                                          echo "selected";
                                      } ?>>
                ...
                <div
                    ...
                    <div id="description" class="lg:p-4 flex flex-col ">
                        <p class="text-[18px] text-justify pt-4 px-3 pb-2 lg:pb-0"><?php if (isset($userDatas->user_description) && !empty($userDatas->user_description)) {
                                echo $userDatas->user_description;
                            } else {
                    ...
                    <button onclick="swapDivsById('description','description-update')"
                        class="bg-main-red w-full text-main-white text-[14px] lg:text-[20px] lg:mt-2 py-2 rounded-b-lg">Editer
                        ma description</button>
                    <?php } ?>
                </div>
                ...
                <div class="flex flex-col lg:flex-row justify-center my-3 lg:my-0 lg:mt-4">
                    <div id="cv" class="flex items-center justify-center lg:flex-row flex-col my-4 lg:my-0 lg:mx-auto">
                        ...
                        <div onclick="swapDivsById('cv','cv-update')"
                            class="modify-cv cursor-pointer flex items-center pt-2 pl-3">
                    ...
                    <?php if ($edit_profil == true) { ?>
                    <form id="cv-update" class="hidden space-x-4" enctype="multipart/form-data">
        ...
        <div class="liens_modal_projets lg:flex lg:flex-row lg:mt-20 lg:px-[3%] lg:mb-8">
            <div class="liens_modal lg:w-1/3">
                ...
                <section class="sites_skills my-5 px-[8%] lg:px-[3%] lg:ml-10">
                    <div class="modify-cv flex items-center pt-2 lg:mb-5">
                        <h3 class="font-title text-[24px] font-bold uppercase lg:mb-3">Sites web
                            ...
                            <i onclick="swapDivsById('links','links-update')"
                                class="fa-solid fa-pen cursor-pointer text-main-red w-[20px] pl-3"></i>
                            <?php } ?>
                        </h3>
                    </div>
                    <div id="links">
                    ...
                    <?php if ($edit_profil == true) { ?>
                    <div id="links-update" class="hidden ">
                        <form id="links-form" class="space-y-2">
                    ...
                    <form id="skills-update" method="POST"
                        ...
                        <select multiple name="skills[]">
                            ...
                            <option value="<?= $eachTag['tag_id'] ?>" <?php if (in_array($eachTag['tag_id'], $userTags)) {
                                          echo "selected";
                                      } ?>>
            ...
            <div class="tab_projets lg:flex lg:flex-col lg:w-2/3">
                    ...
                    <div class="projet-phare">
                        ...
                        <div class="boutons lg:flex lg:flex-row lg:justify-between">
                            ...
                            <div data-modal-target="main-project-update" data-modal-toggle="main-project-update"
                                class="flex items-center mt-5 ml-6 mb-2 cursor-pointer">
                                <span
                    ...
                    <div class="relative w-full h-fit max-w-lg lg:h-auto">
                        <div class="relative bg-main-white border-main-red border-2 rounded-lg text-main-red">
                            ...
                            <div id="co" class="px-6 py-6 lg:px-8">
                                ...
                                <form id="highlight_form" class="space-y-6" enctype="multipart/form-data">
                                    <div>
                ...
                <section class="sectionChange hidden border h-[480px] lg:h-[580px] overflow-y-scroll">
                            ...
                            <div class="relative w-full h-fit max-w-lg lg:h-auto">
                                <div class="relative bg-main-white border-main-red border-2 rounded-lg text-main-red">
                                    ...
                                    <div id="co" class="px-6 py-6 lg:px-8">
                                        ...
                                        <form id="project-update" class="space-y-6" enctype="multipart/form-data">
                                            <div>
                    ...
                    <div data-modal-target="my-project-add" data-modal-toggle="my-project-add"
                        class="flex items-center justify-end mb-5 mt-2 mr-3 cursor-pointer">
                        <span
                            class="w-[40px] h-[40px] border bg-main-red rounded-full mr-2 flex items-center justify-center"><i
                                class="fa-solid fa-plus text-main-white text-[25px] font-bold"></i></span>
                    ...
                    <div class="relative w-full h-fit max-w-lg lg:h-auto">
                        <div class="relative bg-main-white border-main-red border-2 rounded-lg text-main-red">
                            ...
                            <div id="co" class="px-6 py-6 lg:px-8">
                                ...
                                <form id="addProject-form" method="POST" class="space-y-6"
...
handleFormSubmission('#user-status-update', '?action=updateUserElements&type=status&id=<?=$userDatas->user_id?>');
handleFormSubmission('#description-update', '?action=updateUserElements&type=description&id=<?=$userDatas->user_id?>');
handleFormSubmission('#cv-update', '?action=updateUserElements&type=cv&id=<?=$userDatas->user_id?>');
handleFormSubmission('#links-form', '?action=updateUserElements&type=links&id=<?=$userDatas->user_id?>');
handleFormSubmission('#skills-update', '?action=updateUserElements&type=skills&id=<?=$userDatas->user_id?>');
handleFormSubmission('#user-form', '?action=updateUserElements&type=datas&id=<?=$userDatas->user_id?>');
handleFormSubmission('#highlight_form', '?action=updateUserElements&type=highlight&id=<?=$userDatas->user_id?>');
handleFormSubmission('#project-update',
    '?action=updateUserElements&type=modifyMyProject&id=<?=$userDatas->user_id?>&projectID=<?= $project->id ?>');
handleFormSubmission('#addProject-form', '?action=updateUserElements&type=addMyProject&id=<?= $userDatas->user_id ?>');
</script>
