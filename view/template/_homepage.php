...
<video autoplay muted loop class="h-screen hidden lg:block blur-sm absolute w-screen object-cover">
    ...
    <!-- overlay -->
    <div id="homepage-overlay" class="absolute w-screen 2xl:px-[5%] h-screen bg-main-white bg-opacity-60">
        <!-- header logo + titre -->
        ...
        <!-- div cards accueil -->
        <h1 class="hidden lg:block uppercase font-title text-main-white w-fit mx-auto -translate-y-20 text-[60px] font-bold text-center">Simplon <br> charleville-mézières</h1>
        <section id="homepage" class="ease-in duration-300 w-full [&_*]:mx-auto relative
        ...
        <section id="company-homepage" class="opacity-0 hidden ease-in duration-300 w-full [&>*]:mx-auto relative
        [&_button]:block [&_button]:max-w-[410px] [&_button]:bg-main-red [&_button]:w-3/4 [&_button]:py-8 [&_button]:lg:py-20 [&_button]:xl:py-24  [&_button]:my-12 [&_button]:border-main-white [&_button]:border-2 [&_button]:text-main-white [&_button]:font-title [&_button]:font-bold [&_button]:uppercase [&_button]:text-xl [&_button]:lg:text-3xl [&_button]:xl:text-[40px] [&_button]:ease-linear [&_button]:duration-200">
        ...
        <!-- div cards visiteur -->
        <section id="visitor-homepage" class="opacity-0 hidden ease-in duration-300 w-full [&>*]:mx-auto relative
        [&_button]:block [&_button]:max-w-[410px] [&_button]:bg-main-red [&_button]:w-3/4 [&_button]:py-8 [&_button]:lg:py-20 [&_button]:xl:py-24  [&_button]:my-12 [&_button]:border-main-white [&_button]:border-2 [&_button]:text-main-white [&_button]:font-title [&_button]:font-bold [&_button]:uppercase [&_button]:text-xl [&_button]:lg:text-3xl [&_button]:xl:text-[40px] [&_button]:ease-linear [&_button]:duration-200">
