...
<main>
    <section> <!--Téléphone + Adresse -->
        ...
        <div class="grid md:grid-cols-2 sm:gap-8 justify-center md:items-baseline w-2/3 mx-auto mt-8 lg:mt-16">
            <div class="flex flex-wrap justify-center w-auto mb-8">
                <i class="fa-solid fa-phone-volume text-[24px] xl:text-[36px] text-center w-full mt-2 text-main-red"></i>
                <p class="font-bold mb-4 text-[24px] xl:text-[36px] whitespace-nowrap  w-full sm:whitespace-normal text-center">Nous appeler :</p>
    ...
    <section>
        <iframe class="w-11/12 mx-auto lg:h-[300px] xl:h-[400px]" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1216.88710206817!2d4.722451118316222!3d49.739151769884515!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47ea0d52508ce1b1%3A0x728f7af63c73d095!2sMaison%20du%20campus!5e0!3m2!1sfr!2sfr!4v1683797825936!5m2!1sfr!2sfr" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </section>
    <section>
