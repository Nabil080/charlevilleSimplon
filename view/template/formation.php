...
<main>
    <h2
        class="py-5 bg-main-white text-center text-[24px] md:text-[36px] lg:text-[48px] font-bold font-title text-main-red uppercase">
        Développeur Web
        et Web Mobile
    </h2>
    <section class="bg-main-white pb-10 px-[10%] xl:px-[15%]">
    ...
    <section class="py-10 lg:px-[10%] xl:px-[15%] bg-main-lightgray">
        <div class="border border-main-lightGray">
            <ul class="grid grid-cols-2 lg:grid-cols-4 " id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                <li role="presentation" class="border border-white bg-main-gray ">
                    <button
                        class="w-full p-5 inline-flex justify-center items-center gap-3 text-[16px] md:text-[28px] text-main-white aria-selected:bg-main-red aria-selected:text-main-white"
            ...
            <div id="myTabContent" class="bg-white pb-10 px-4">
                <div class="hidden text-[16px] lg:text-[20px]" id="skill" role="tabpanel" aria-labelledby="skill-tab">
                    <div class="py-4">
                ...
                <div class="hidden px-4 bg-white text-[16px] lg:text-[20px]" id="admission" role="tabpanel"
                ...
                <div class="hidden px-4 bg-white text-[16px] lg:text-[20px]" id="program" role="tabpanel"
                ...
                <div class="hidden px-4 bg-white text-[16px] lg:text-[20px]" id="financing" role="tabpanel"
    ...
    <section class="bg-main-lightgray pb-20 px-[10%] xl:px-[15%]">
        <div class="flex items-center gap-4 text-main-red">
