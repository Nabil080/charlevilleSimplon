        ...
        <div id="homepage" class="h-2/3 lg:h-2/5 ease-in duration-300 w-full lg:flex lg:flex-col lg:grow lg:gap-6 ">
            ...
            <div class="lg:hidden w-full flex justify-center">
                <div data-modal-target="login-modal" data-modal-toggle="login-modal"
                    class="underline font-main cursor-pointer font-semibold">se connecter</div>
            </div>
        </div>
        <!-- ENTREPRISE TITRE + BOUTONS -->
        <div id="company-homepage"
            class="hidden opacity-0 h-2/3 lg:h-2/5 ease-in duration-300 w-full lg:flex-col lg:grow lg:gap-6 ">
            <div class="h-1/5 font-title font-bold text-[5vh] lg:text-[7vh] text-main-white grid items-center">
                <p>Je souhaite</p>
            </div>
            <!-- BOUTONS -->
            ...
            <div class="my-auto w-full flex justify-center">
                <div onclick="returnHomepage('company-homepage')"
                    class="cursor-pointer font-semibold font-main text-main-white text-xl shadow-2xl"><i
                        class="fa-solid fa-angle-left"></i> Retour</div>
            </div>
        </div>
...
<section id="login-modal" data-modal-placement="center" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full h-fit max-w-md md:h-auto">
        <div class="relative bg-main-white border-main-red border-2 rounded-md text-main-red">
            <button type="button"
                class="absolute top-3 right-2.5 text-main-red bg-transparent rounded-md text-sm p-1.5 ml-auto inline-flex items-center hover: hover:border border-main-red"
            ...
            <div id="co" class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="/portfolio/allosimplon/traitements/connexion/login.php" method="post">
                    ...
                    <div>
                        ...
                        <div class="text-sm font-bold text-main-gray">
                            Pas de compte ? <a href="index.php?action=registerPage&campany=true"
                                class="hover:underline text-main-red cursor-pointer">S'inscrire</a>
