...
<nav id="navbar"
    class="w-[100vw] fixed top-0 left-0 z-40 transition-all duration-[0.3s] shadow-[3px_5px_10px] shadow-[#1111114d] blur-[0.2px]">
    <div
                ...
                <?php if (isset($_SESSION['user'])) { ?>
                    <div>
                        ...
                        <div id="dropdownAccount"
                            class="z-50 border-main-lightgray hidden bg-main-white rounded-lg shadow w-fit mr-4 pl-0 border-main-lightgray">
                            <ul class="z-50 relative py-2 md:py-0 px-6 md:px-0 text-sm leading-9 sm:leading-[60px] text-gray-700 divide-y border-2 border-main-red divide-main-red rounded-[4px]"
                                ...
                                <li class="md:hover:bg-main-lightred">
                                    <a href="?action=crudCandidatePage"
