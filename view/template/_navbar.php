<nav class="w-[100vw] fixed top-0 left-0 transition-all duration-[0.3s]">
    <div
        ...
        <i onclick="changeNavFunction()"
            class="fa-solid fa-xmark text-[46px] justify-self-end mr-4 mb-1 hidden md:hidden"></i>
        <div
            ...
            <div
                ...
                <div>
                    <button data-dropdown-toggle="dropdown"
                        class="focus:outline-none rounded-[4px] text-[24px] sm:text-[36px] md:text-[20px] text-center inline-flex items-center"
                        type="button">Formations
                    ...
                    <div id="dropdown"
                        class="z-10 border-main-lightgray hidden bg-main-white rounded-lg shadow w-full mr-4 pl-0 border-main-lightgray">
                        <ul class="z-100 relative py-2 px-2 text-sm leading-9 sm:leading-[60px] text-gray-700 divide-y border-2 border-main-red divide-main-red rounded-[4px]"
                            aria-labelledby="dropdownDefaultButton">
                            <li class="md:hover:bg-main-lightred">
                                <a href="#" class="block px-4 py-2 text-[22px] sm:text-[32px] md:text-[20px] ">Découvrir
                                    nos
                                    formations</a>
                            </li>
                            <li class="md:hover:bg-main-lightred">
                            ...
                            <li class="md:hover:bg-main-lightred">
                                <a href="#" class="block px-4 py-2 text-[22px] sm:text-[32px] md:text-[20px]">Référent
                                    Digital</a>
                            </li>
                            <li class="md:hover:bg-main-lightred">
                                <a href="#" class="block px-4 py-2 text-[22px] sm:text-[32px] md:text-[20px]">Technicien
                                    supérieur
                                    système et réseaux</a>
                            </li>
                            <li class="md:hover:bg-main-lightred">
                                <a href="#" class="block px-4 py-2 text-[22px] sm:text-[32px] md:text-[20px]">Concepteur
                                    développeur
                                    d'applications</a>
                            </li>
                        </ul>
