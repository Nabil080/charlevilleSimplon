...
>
  ...
  >
    <a href="index.php"
      ><img
        src="assets/img/navbar/logo-simplon.png"
        alt="Logo Simplon"
        class="w-[171px]"
    /></a>
    <i
      onclick="changeNavFunction()"
      class="fa-solid fa-bars text-[39px] justify-self-end mr-6 sm:mr-8 mb-1 md:hidden hiddenIcon"
    ></i>
    <i
      onclick="changeNavFunction()"
    ...
    >
      ...
      >
        <?php 
            if (isset($_SESSION['user']->role->id) &&
        $_SESSION['user']->role->id == 1) { ?>
        <i
          class="md:ml-2 hiddenIcon fa-solid fa-screwdriver-wrench text-[44px] sm:text-[62px] justify-self-center md:text-[20px]"
          style="color: #bd3124"
        ></i>
        ...
        <?php
          ...
          ?>
        <i
          class="md:ml-2 fa-solid fa-file-lines text-[44px] sm:text-[62px] md:text-[20px] justify-self-center"
          style="color: #bd3124"
        ></i>
        <!-- Dropdown menu -->
        <div>
        ...
        <i
          class="md:ml-2 fa-solid fa-users text-[44px] sm:text-[62px] justify-self-center md:text-[20px]"
          style="color: #bd3124"
        ></i>
        ...
        <i
          class="md:ml-2 fa-solid fa-book text-[44px] sm:text-[62px] justify-self-center md:text-[20px]"
          style="color: #bd3124"
        ></i>
        <p class="text-[24px] sm:text-[36px] md:text-[20px] xl:text-[24px]">
        ...
        <i
          class="md:ml-2 fa-solid fa-user text-[44px] sm:text-[62px] justify-self-center md:text-[20px]"
          style="color: #bd3124"
        ></i>
