        ...
        <div
            ...
            <div
                    ...
                    <div id="dropdown"
                        ...
                        <ul class="z-50 relative py-2 md:py-0 px-2 md:px-0 text-sm leading-9 sm:leading-[60px] text-gray-700 divide-y border-2 border-main-red divide-main-red rounded-[4px]"
                            ...
                            <li class="md:hover:bg-main-lightred">
                                <a href="?action=allFormationsPage"
                                    class="block px-4 py-2 text-[22px] sm:text-[32px] md:text-[20px] ">Découvrir nos
                                    formations</a>
                            </li>
                            <li class="md:hover:bg-main-lightred">
                                <a href="?action=formationPage"
                ...
                <i class="md:ml-2 fa-solid fa-book text-[44px] sm:text-[62px] justify-self-center  md:text-[20px]"
                    style="color: #BD3124;"></i>
                <p class="text-[24px] sm:text-[36px] md:text-[20px] xl:text-[24px]"><a
                        href="?action=allProjectsPage">Projets</a></p>
