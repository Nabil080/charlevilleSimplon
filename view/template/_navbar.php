  ...
  <div class="grid grid-cols-2 transition-all duration-[0.2s] items-center bg-main-white border-t-[4px] md:grid-cols-[20%_80%] border-main-red">
    ...
    <div class="changeNav hidden md:grid bg-main-lightred md:bg-main-white col-start-1 col-end-3 md:col-start-auto md:justify-self-end md:mr-2 lg:mr-4 xl:mr-6 translate-x-[80vw] md:translate-x-0 duration-[0.4s] ease-out transition-all">
      <div class="grid grid-cols-[25%_60%] sm:mx-auto sm:w-[40%] items-center pt-8 gap-8 md:mr-4 md:pt-0 md:inline-flex md:w-full md:gap-2">
        ...
        <!-- Dropdown menu -->
        <div>
          <button data-dropdown-toggle="dropdown" class="focus:outline-none rounded-[4px] text-[24px] sm:text-[36px] md:text-[20px] xl:text-[24px] text-center inline-flex items-center" type="button">
            Formations
            <svg class="w-8 h-8 ml-2 transition-all  duration-[1s]  linear" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
          </button>
          <div id="dropdown" class="z-50 border-main-lightgray hidden bg-main-white rounded-lg shadow w-fit mr-4 pl-0 border-main-lightgray">
        ...
        <?php if (isset($_SESSION['user'])) { ?>
          <div>
            <button data-dropdown-toggle="dropdownAccount" class="focus:outline-none rounded-[4px] text-[24px] sm:text-[36px] md:text-[20px] xl:text-[24px] text-center inline-flex items-center" type="button">
              Compte
              <svg class="w-8 h-8 ml-2 transition-all  duration-[1s]  linear" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
              </svg>
            </button>
            <div id="dropdownAccount" class="z-50 border-main-lightgray hidden bg-main-white rounded-lg shadow w-fit mr-4 pl-0 border-main-lightgray">
              <ul class="z-50 relative py-2 md:py-0 px-6 md:px-0 text-sm leading-9 sm:leading-[60px] text-gray-700 divide-y border-2 border-main-red divide-main-red rounded-[4px]" aria-labelledby="dropdownAccountDefaultButton">
        ...
        ?>
          <button type="button" id="connexion" class="text-[24px] sm:text-[36px] md:text-[20px] xl:text-[24px] cursor-pointer" data-modal-target="login-modal" data-modal-toggle="login-modal">
            Connexion
          </button>
        <?php
        }
