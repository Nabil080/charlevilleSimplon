        ...
        <div class="section-cards md:flex md:flex-wrap md:justify-around">
            ...
            <div class="card_formation rounded-[5px] border-[1px] m-3 border-main-border md:w-2/5">
                ...
                <div class="card_buttons flex justify-around pb-6 pt-2">
                    <a href="" class="bg-main-red rounded-[5px] text-main-white font-medium flex items-center justify-center text-[14px] font-main w-1/3 py-2 px-3">En savoir plus</a>
        ...
        <ol class="border-l border-neutral-300 md:flex md:justify-center md:gap-6 md:border-l-0 md:border-t">
            <li>
                <div class="flex-start flex items-center pt-2 md:block md:pt-0">
                    ...
                    <span class="mt-2 text-xl font-semibold">2013</span>
                </div>
            </li>
            <li>
                <div class="flex-start flex items-center pt-2 md:block md:pt-0">
                    <div class="-ml-[5px] mr-3 h-[9px] w-[9px] rounded-full bg-neutral-300 dark:bg-neutral-500 md:-mt-[5px] md:ml-0 md:mr-0"></div>
                    <span class="mt-2 text-xl font-semibold">2014-2015</span>
                </div>
            </li>
            <li>
                <div class="flex-start flex items-center pt-2 md:block md:pt-0">
                    <div class="-ml-[5px] mr-3 h-[9px] w-[9px] rounded-full bg-neutral-300 dark:bg-neutral-500 md:-mt-[5px] md:ml-0 md:mr-0"></div>
                    <span class="mt-2 text-xl font-semibold">2016-2017</span>
                </div>
            </li>
            <li>
                <div class="flex-start flex items-center pt-2 md:block md:pt-0">
                    <div class="-ml-[5px] mr-3 h-[9px] w-[9px] rounded-full bg-neutral-300 dark:bg-neutral-500 md:-mt-[5px] md:ml-0 md:mr-0"></div>
                    <span class="mt-2 text-xl font-semibold">2018-2019</span>
                </div>
            </li>
            <li>
                <div class="flex-start flex items-center pt-2 md:block md:pt-0">
                    <div class="-ml-[5px] mr-3 h-[9px] w-[9px] rounded-full bg-neutral-300 dark:bg-neutral-500 md:-mt-[5px] md:ml-0 md:mr-0"></div>
                    <span class="mt-2 text-xl font-semibold">2020-2021</span>
                </div>
            </li>
        </ol>
