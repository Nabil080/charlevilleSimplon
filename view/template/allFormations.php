...
<div class="background bg-main-white">
    ...
    <div class="section_learn bg-main-white pb-5 mx-2 md:mx-[5%] lg:mx-[10%]">
        <h2 class="text-main-red font-title text-center text-[24px] font-semibold pt-4 mb-8 italic lg:text-[42px] lg:text-left">Apprendre à Simplon</h2>
        <div class="block lg:grid lg:grid-cols-[10%_90%] items-center justify-center">
            ...
            <p class="mx-7 py-5 font-main text-[16px] text-justify tracking-wide">La méthode d’apprentissage
                <span class="italic">Simplon.co</span>, <strong>c’est une pédagogie active et par projets</strong> où l’apprenant est confronté
                à des mises en situation concrètes via des projets individuels et en groupe. Les thèmes des projets sont directement issus
                de cas réels, pour permettre aux apprenants d’appréhender le terrain dès la formation. Le collectif est un élément central de
                l’apprentissage car <strong>le travail en équipe est constant</strong>, et les apprenants s’entraident et s’évaluent
                régulièrement.</p>
            ...
            <p class="mx-7 py-5  font-main text-[16px] text-justify tracking-wide">Pour garantir une
                <strong>insertion professionnelle réussie</strong>, l’apprenante est accompagnée par des formateurs experts du métier visé et
                 des équipes en lien avec les entreprises du territoire. Il est immergé dans le monde de l’entreprise tout au long de sa
                 formation : parrainage de la promotion par une entreprise, simulations d’entretiens, meet-ups...</p>
            <i class="fa-solid text-center w-full fa-graduation-cap text-[32px] my-2 text-main-red lg:text-[55px]"></i>
            <p class="mx-7 py-5  font-main text-[16px] text-justify tracking-wide">Quasiment toutes nos formations débouchent sur la
                <strong>délivrance de certifications reconnues</strong>, soit un Titre RNCP reconnu par le ministère du travail
                (équivalent diplôme), soit une ou plusieurs certifications Simplon reconnues par l'État ou par les professionnels.</p>
            </div>
            <div class="flex justify-center mt-4 lg:mt-8">
                <a href="" class="bg-main-red rounded-[5px] text-main-white font-semibold text-[16px] lg:text-[22px] font-main py-5 px-3 inline">Projets réalisés par nos formations</a>
            </div>
    </div>
    ...
    <div class="section_history relative">
        <h2 class="text-main-red font-title text-center text-[24px] lg:text-[42px] italic lg:text-left lg:w-3/4 lg:mx-auto font-semibold py-5 mt-4 mb-8">Notre histoire</h2>
        <!-- Timeline -->
