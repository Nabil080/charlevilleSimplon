<section > <!-- Navigation -->       
    ...
    <aside id="sidebar-multi-level-sidebar" class="fixed transition-all duration-[0.5s] md:top-20 left-0 z-40 w-full md:w-64 h-screen transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
