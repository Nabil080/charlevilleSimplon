            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left ">
                    <thead class="text-xs text-gray-700 uppercase bg-main-red text-main-white ">
                        <tr>
                            <th scope="col" class="px-4 py-3 text-center"><?= "" ?> Nom du projet</th>
                            <th scope="col" class="px-4 py-3 text-center"><?= "" ?> Nom de l'entreprise</th>
                            <th scope="col" class="px-4 py-3 text-center"><?= "" ?> Promotion</th>
                            <th scope="col" class="px-4 py-3 text-center"><?= "" ?> Cahier des charges</th>
                            <th scope="col" class="px-4 py-3 text-center"><?= "" ?> Fiche de projet</th>
                    ...
                    <tbody class="border-2">
                        ...
                        <tr class="border-2 border-gray-800">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 border whitespace-nowrap ">Super projet de fou</th>
                            ...
                            <td class="px-4 py-3 border">
                                ...
                                <a  href="$cahier des charges"
                                    class="block cursor-pointer w-full md:w-1/2 text-white bg-main-gray hover:bg-red-800 focus:ring-4 focus:outline-none 
                                     font-medium rounded-lg text-sm px-5 py-2.5 mt-2 mx-auto text-center" type="button">
                                        <i class="fa-solid fa-file"></i>
                                </a>
                            </td>
                            <td class="px-4 py-3 border">
                                <a href="$link page projet"
                                    class="block cursor-pointer w-full md:w-1/2 text-white bg-main-gray hover:bg-red-800 focus:ring-4 focus:outline-none 
                                     font-medium rounded-lg text-sm px-5 py-2.5 mt-2 mx-auto text-center" type="button">
