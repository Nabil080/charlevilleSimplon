<!-- Extra Large Modal -->
<div id="modal-candidature<?php "" ?>" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-7xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                ...
                data-modal-hide="modal-candidature<?php '' ?>">
           ...
           <div class="description md:ml-5 h-[100%] flex flex-col">
               ...
               <div class="text-desc rounded-[5px] border-[1px] border-main-border mt-5 grow md:flex md:flex-col md:justify-between">
                   <p class="text-[20px] text-justify py-5 px-3">Ma candidature</p>
        ...
        <!-- Description profil apprenant -->
            ...
            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button data-modal-hide="modal-candidature<?php "" ?>" type="button" class="text-gray-500 bg-white hover:bg-gray-100 
