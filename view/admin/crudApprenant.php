<table class="w-full text-sm text-left ">
    ...
    <tbody class="border-2">
        ...
        <tr class="border-2 border-gray-800">
            <th scope="row" class="px-4 py-3 font-medium text-gray-900 border whitespace-nowrap ">Apple iMac
                27&#34;</th>
            ...
            <td class="px-4 py-3 border">
                <button data-modal-target="modal-info<?php "" ?>" data-modal-toggle="modal-info<?php "" ?>" class="block w-full md:w-auto text-white bg-main-red hover:bg-red-800 focus:ring-4 focus:outline-none 
