    ...
    <div class="relative w-full max-w-7xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                ...
                rounded-lg text-sm p-1.5 ml-auto inline-flex items-center " data-modal-hide="modal-formateur-<?= $promo->id ?>">
            ...
            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button data-modal-hide="modal-formateur-<?= $promo->id ?>" type="button" class="text-gray-500 bg-white hover:bg-gray-100 
