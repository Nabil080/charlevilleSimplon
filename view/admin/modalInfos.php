<!-- Extra Large Modal -->
<div id="modal-info<?php '' ?>" tabindex="-1"
    ...
    <div class="relative w-full max-w-7xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                ...
                dark:hover:text-white" data-modal-hide="modal-info<?php '' ?>">
            ...
            <div class="p-6 space-y-6">
                <div class="background bg-main-white overflow-x-hidden min-h-[100vh]">
                    ...
                    <div class="picture_desc grid grid-cols-1 lg:grid-cols-[40%_60%] items-center  px-[8%] 2xl:px-[5%]">
                        ...
                        <div class="description md:ml-5 h-[100%] flex flex-col">
                            <h1
                                ...
                                <span class="uppercase">$nom</span> $prenom</h1>
                            <div
                                class="text-desc rounded-[5px] border-[1px] border-main-border mt-5 grow md:flex md:flex-col md:justify-between">
                    ...
                    <div
                        ...
                        <button data-modal-hide="modal-info<?php "" ?>" type="button" class="text-gray-500 bg-white hover:bg-gray-100 
