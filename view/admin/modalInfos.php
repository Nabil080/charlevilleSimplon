<!-- Extra Large Modal -->
<div id="modal-info-<?= $user->user_id ?>" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-7xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                ...
                dark:hover:text-white" data-modal-hide="modal-info-<?= $user->user_id ?>">
            ...
            <div class="p-6 space-y-6">
                <div class="background bg-main-white overflow-x-hidden min-h-[100vh]">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button data-modal-hide="modal-info-<?=$user->user_id?>" type="button" class="text-gray-500 bg-white hover:bg-gray-100 
